...
# save the country_iso3 dictionary as a csv file
country_iso3_df = pd.DataFrame.from_dict(country_iso3, orient='index')
country_iso3_df.to_csv('data-clean/country_iso3.csv', index=True, header=False)